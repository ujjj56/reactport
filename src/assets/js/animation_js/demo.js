 ...
 */
{
    ...
    class Content {
        constructor(el) {
			...
			this.DOM.text2 = this.DOM.el.querySelector('.content__item-text2');
		...
		toggle(delay, withAnimation, show = true) {
			setTimeout(() => {
				...
				this.DOM.text2.style.opacity = show ? 1 : 0;
    ...
    class Grid {
        constructor(el) {
			...
			this.DOM.closeCtrl2 = document.querySelector('.content__prv');
			this.DOM.closeCtrl3 = document.querySelector('.content__nxt');
		...
		toggleContentElems(contentEl, delay, withAnimation, show = true) {
			...
			TweenMax.to([this.DOM.closeCtrl, this.DOM.closeCtrl2, this.DOM.closeCtrl3, this.DOM.scrollIndicator], withAnimation ? 0.8 : 0, {
